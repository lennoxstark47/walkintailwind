				...
				<div className='container mx-auto w-5/6  rounded-lg max-w-md shadow-lg hover:shadow-lg transition duration-300'>
					<div className='py-12  p-10  rounded-lg mt-5 h-full  bg-violet-200'>
						<div className='mb-6'>
							...
							<input
								type='text'
								className='mr-4 bg-white w-full text-gray-100 py-2 px-4 lg:w-96 border-transparent focus:ring-2 focus:ring-indigo-400 rounded'
							/>
							...
							<input
								...
								className='mr-4 bg-white w-full text-gray-100 py-2 px-4 lg:w-96 border-transparent focus:ring-2 focus:ring-indigo-400 rounded'
							/>
							<button className='lg:w-96 w-full mt-6 text-indigo-50 font-bold bg-indigo-600 py-3 rounded-md hover:bg-indigo-500 transition duration-300'>
								Submit
							</button>
						</div>
					</div>
